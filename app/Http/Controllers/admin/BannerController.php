...
class BannerController extends CommonController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            $banner->image = (new Helper())->imageUpload(
                $request->image,
                "banner"
            );
        }
        ...
        return response()->json(
            ["success" => true, "data" => $banner, "msg" => "Banner create"],
            200
        );
    }
    ...
    public function show($id)
    {
        ...
        return response()->json(
            ["success" => true, "data" => $data, "msg" => "Banner show"],
            200
        );
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("image")) {
            if (
                \File::exists(
                    public_path("/storage/images/banner/" . $banner->image)
                )
            ) {
                \File::delete(
                    public_path("/storage/images/banner/" . $banner->image)
        ...
        $banner->save();
        return response()->json(
            ["success" => true, "data" => $banner, "msg" => "Banner edit"],
            200
        );
    }
    ...
    public function destroy($id)
    {
        ...
        $banner->delete();
        return response()->json(
            ["success" => true, "data" => $banner, "msg" => "Banner Deleted"],
            200
        );
    }
