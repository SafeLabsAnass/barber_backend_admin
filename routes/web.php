...
Route::any("installer", [LoginController::class, "license"]);
...
Route::group(["middleware" => ["XssSanitizer"]], function () {
    ...
    Route::post(
        "/admin/forgetpassword/change",
        "Auth\LoginController@adminforgetpassword"
    );
    ...
    Route::prefix("admin")
        ...
        ->group(function () {
            ...
            Route::post(
                ...
                "admin\LanguageController@hideLanguage"
            );
            Route::post(
                "/language/changeDirection",
                "admin\LanguageController@changeDirection"
            );
            ...
            Route::get(
                "/adminuserchartdata",
                "admin\DashboardController@adminUserChartData"
            );
            Route::get(
                "/adminuserchartmonthdata",
                "admin\DashboardController@adminUserMonthChartData"
            );
            Route::get(
                "/adminusercharweekdata",
                "admin\DashboardController@adminUserWeekChartData"
            );
            Route::get(
                "/adminrevenuechartdata",
                "admin\DashboardController@adminRevenueChartData"
            );
            Route::get(
                "/adminrevenuechartmonthdata",
                "admin\DashboardController@adminRevenueMonthChartData"
            );
            Route::get(
                "/adminrevenuecharweekdata",
                "admin\DashboardController@adminRevenueWeekChartData"
            );
            ...
            Route::post(
                "/profile/update",
                "admin\SettingController@admin_update"
            );
            Route::post(
                "/profile/changepassword",
                "admin\SettingController@admin_changePassword"
            );
            ...
            Route::post(
                ...
                "admin\CategoryController@hideCategory"
            );
            ...
            Route::post(
                "/services/hideService",
                "admin\ServiceController@hideService"
            );
            Route::get(
                "/services/delete/{id}",
                "admin\ServiceController@destroy"
            );
            ...
            Route::post(
                "/employee/update/{id}",
                "admin\EmployeeController@update"
            );
            Route::post(
                "/employee/hideEmp",
                "admin\EmployeeController@hideEmp"
            );
            Route::get(
                "/employee/delete/{id}",
                "admin\EmployeeController@destroy"
            );
            ...
            Route::get(
                "/gallery/delete/{id}",
                "admin\GalleryController@destroy"
            );
            Route::post(
                "/gallery/hideGallery",
                "admin\GalleryController@hideGallery"
            );
            ...
            Route::post(
                "/banner/hideBanner",
                "admin\BannerController@hideBanner"
            );
            ...
            Route::post(
                "/coupon/hideCoupon",
                "admin\CouponController@hideCoupon"
            );
            ...
            Route::get(
                "/notification/send",
                "admin\NotificationController@send"
            );
            Route::post(
                "/notification/store",
                "admin\NotificationController@store"
            );
            ...
            Route::post(
                "/license/update/{id}",
                "admin\SettingController@update_license"
            );
            Route::get("/test_mail", [SettingController::class, "testMail"]);
            ...
            Route::get(
                "/booking/invoice/{id}",
                "admin\BookingController@invoice"
            );
            Route::get(
                "/booking/invoice/print/{id}",
                "admin\BookingController@invoice_print"
            );
            ...
            Route::post(
                ...
                "admin\BookingController@changeStatus"
            );
            Route::post(
                "/booking/changepaymentstatus",
                "admin\BookingController@changePaymentStatus"
            );
            Route::post(
                "/booking/paymentcount",
                "admin\BookingController@paymentcount"
            );
            Route::post(
                "/booking/timeslot",
                "admin\BookingController@timeslot"
            );
            Route::post(
                "/booking/selectemployee",
                "admin\BookingController@selectemployee"
            );
...
Route::prefix("admin")
    ...
    ->group(function () {
        ...
        Route::get(
            ...
            "admin\NotificationController@template"
        );
        Route::get(
            "/notification/template/edit/{id}",
            "admin\NotificationController@edit_template"
        );
        Route::post(
            "/notification/template/update/{id}",
            "admin\NotificationController@update_template"
        );
...
Route::get("/terms-conditions", "RuleController@getTermsAndConditions");
Route::get("/privacy-policy", "RuleController@getPrivacyPolicy");
